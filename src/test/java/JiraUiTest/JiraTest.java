...
public class JiraTest extends WebHooks {
    ...
    public void JTest() {
        ...
        countsTask(); // ловим число задач в процессе и выводим на экран счетчик, обрезав первые 5 знаков + в строке поиска ищем "TestSelenium"+ проверям переход на страницу результатом поиска
        ...
        createBug();//Создаем БАГ
        changeStatusTask(); //Меняем статус созданной задачи
